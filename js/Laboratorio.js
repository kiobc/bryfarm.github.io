...
$('#form-crear-laboratorio').submit(e=>{
    ...
    $.post('../controlador/laboratoriocontroler.php',{nombre_laboratorio,id_editado,funcion},(response)=>{
        if(response=='add'){
            $('#add-laboratorio').hide('slow');
            $('#add-laboratorio').show(1000);
            $('#add-laboratorio').hide(2500);
        ...
        if (result.value) {
            $.post('../controlador/laboratoriocontroler.php',{id,funcion},(response)=>{
                ...
                if(response=='borrado'){
                    swalWithBootstrapButtons.fire(
                        'Borrado!',
                        'El laboratorio '+nombre+' ha sido borrado.',
                        'success'
                      )
                      buscar_lab();
                }
                    ...
                    swalWithBootstrapButtons.fire(
                        'No se pudo borrar!',
                        'El laboratorio '+nombre+' no fue borrado porque está siendo usado por un productos.',
                        'error'
                    )
          ...
          swalWithBootstrapButtons.fire(
            'Cancelado',
            'El laboratorio '+nombre+' no ha sido borrado',
            'error'
          )
          buscar_lab();
        }
