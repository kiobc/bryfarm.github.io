    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form id="form-confirmar">
            ...
            <input id="oldpass" type="password" class="form-control" placeholder="Ingrese Password ">
    ...
    <div class="modal-content">
     <div class=" card card-success">
        ...
        <div class="alert alert-danger text-center" id="noadd" style='display:none;'>
                        <span><i class="fas fa-times m-1"></i>La cédula ya existe</span>
         </div>
           <form id="form-crear">
             ...
             <div class="form-group">
               ...
               <input id="edad"type="date" class="form-control" placeholder="Ingrese fecha nacimiento" required>
             </div>
             <div class="form-group">
               <label for="dni">Cédula</label>
               <input id="dni"type="text" class="form-control" placeholder="Ingrese Cédula" required>
             </div>
             <div class="form-group">
           ...
           <div class=" card card-success">
               <div class="card-header">
                   ...
                   <div class="input-group">
                       <input type="text" id="buscar" class="form-control float-left " placeholder="Ingrese el nombre del usuario">
